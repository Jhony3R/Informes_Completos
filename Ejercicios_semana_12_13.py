...
# 1. Implementa una función que determine si una palabra es palíndroma o 
...
# 2. Crea un sistema de gestión de pedidos que utilice una cola para procesar 
...
# 4. Implementa un sistema de gestión de tareas que permita agregar tareas, 
...
# Contar nodos:
# 5. Implementar una función que cuente la 
...
def contar_nodos_hoja(raiz):
    if raiz is None:
        return 0
    elif raiz.izquierda is None and raiz.derecha is None:
        return 1
    else:
...
# 8. Implementar una función que calcule la altura del 
...
# 9. Implementar una función que calcule la profundidad de un 
